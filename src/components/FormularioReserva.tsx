import React, { useState,  } from 'react'; // Agregar useContext
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-3xl mx-auto bg-white shadow-md rounded p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* Origen */}
        <div>
          <label className="block text-gray-700">Lugar de Origen</label>
          <select
            name="origen"
      ...
      <div className="grid grid-cols-2 gap-4 items-center">
        ...
        <div>
          ...
          >
            <option value="">Selecciona una opción</option>
            <option value="Suburban negra para 5 pasajeros">Suburban negra para 5 pasajeros</option>
            <option value="Suburban blanca para 5 pasajeros">Suburban blanca para 5 pasajeros</option>
            <option value="Camioneta Jack de 10 pasajeros">Camioneta Jack de 10 pasajeros</option>
            <option value="Ford Escape de 5 pasajeros">Ford Escape de 5 pasajeros</option>
          </select>
        </div>
      </div>
      ...
      <div className="bg-yellow-100 p-4 rounded text-center text-yellow-700">
        <p>Nos pondremos en contacto contigo para fijar la hora</p>
      </div>
